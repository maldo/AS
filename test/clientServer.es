...
app.get('/fail', function (req, res) {
	res.send('You have denied access to the AS');
});

app.get('/oauth/AS', passport.authenticate('AS'),
	function(req, res){

	//log.debug('request query in get /auth/AS')(req.query);
	// The request will be redirected to GitHub for authentication, so this
	// function will not be called.
});

// GET /auth/github/callback
app.get('/oauth/AS/callback', 
	passport.authenticate('AS', { failureRedirect: '/fail' }),
	function (req, res) {
